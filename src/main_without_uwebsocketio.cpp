...
int main() {
    ...
    //cout << "\tid: " << best_particle.id << "\tx: " << best_particle.x << "\n\ty: " << best_particle.y << "\n\ttheta: " << best_particle.theta << endl;
		...
		cout << "Cumulative mean weighted error: x " << cum_mean_error[0] << " y " << cum_mean_error[1] << " yaw " << cum_mean_error[2] << "\n" << endl;
